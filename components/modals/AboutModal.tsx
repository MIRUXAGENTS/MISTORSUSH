...
export default function AboutModal({ isOpen, onClose }: AboutModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="bg-dark border border-white/10 w-full max-w-2xl rounded-[2.5rem] overflow-hidden relative animate-fade-in shadow-[0_0_50px_rgba(0,0,0,0.5)]">
        ...
        <div className="px-8 pb-10 -mt-12 relative">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-brand font-bold text-xs uppercase tracking-widest mt-1">
              {lang === 'ru' ? 'Авторский проект Владислава Мазура' : 'Original Project by Vladislav Mazur'}
            </p>
            ...
            <div className="space-y-6 text-white/80 text-sm leading-relaxed max-h-[50vh] overflow-y-auto custom-scrollbar pr-2">
              ...
              <p>
                {lang === 'ru'
                  ? 'Основатель и шеф-повар проекта — Владислав Мазур, предприниматель из Ашкелона, который превратил свою любовь к созданию идеальных суши в дело всей жизни. Mistorsushi — это не массовое производство, а личный бренд, построенный на принципах самосовершенствования и искренней любви к своему делу.'
              ...
              <div className="grid grid-cols-1 gap-4 text-left">
                <div className="bg-white/5 p-4 rounded-2xl border border-white/5">
                  <h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2">
                    <span className="text-brand text-base">✨</span> {lang === 'ru' ? 'Только лучшее' : 'Only the Best'}
                  </h3>
                ...
                <div className="bg-white/5 p-4 rounded-2xl border border-white/5">
                  <h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2">
                    <span className="text-brand text-base">🍣</span> {lang === 'ru' ? 'Авторский подход' : 'Signature Approach'}
                  </h3>
                  <p className="text-xs opacity-70">
                    {lang === 'ru'
                ...
                <div className="bg-white/5 p-4 rounded-2xl border border-white/5">
                  <h3 className="text-white font-bold text-xs uppercase tracking-wider mb-2 flex items-center gap-2">
                    <span className="text-brand text-base">❤️</span> {lang === 'ru' ? 'Эстетика и удовольствие' : 'Aesthetics and Pleasure'}
                  </h3>
                  <p className="text-xs opacity-70">
                    {lang === 'ru'
